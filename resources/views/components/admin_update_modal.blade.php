      ...
      <form method="post" id="update_admin_form" autocomplete="off">
         ...
         <div class="form-group">
            <input type="text" name="name" class="form-control" 
              value="{{$user->name??''}}" placeholder="Admin Name" required />
         </div>

         <div class="form-group">
            <input type="email" name="email" class="form-control" 
              value="{{$user->email??''}}" placeholder="Admin Email" required />
         </div>

         <div class="form-group">
            <select type="text" name="status" class="form-control"  required>
              <option value="active" class="form-control" @if ($user->status == 'active') selected @endif>Active</option>
              <option value="inactive" class="form-control" @if ($user->status == 'inactive') selected @endif>Inactive</option>
            </select>
         </div>
