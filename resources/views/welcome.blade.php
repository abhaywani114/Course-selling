...
<div class="slide-1  pt-3" id="teachers-section" >
   <div class="container ">
	 ...
	 <div class="col-lg-7 text-center aos-init aos-animate" data-aos="fade-up" data-aos-delay="">
        ...
        <h4 style="align:center; color:white;">We would love to hear from you, if you are interested to join us & become a faculty, please get in touch & <a href="mailto:thefrcsmentor@gmail.com">drop us an email.</a></h4>
	 </div>
	  </div>
...
@foreach ([ 'a' => '2021-04-17', 'feb' => '2021-02-20', 'mar' => '2021-03-27', 'april' => '2021-04-03'  ] as $key => $value)
<!-- Modal -->
