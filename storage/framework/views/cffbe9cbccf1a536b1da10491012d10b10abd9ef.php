		...
		<div class="modal-body">
			<form method="post" id="update_course_form">
				...
				<div class="form-group">
					...
					<input type="number" name="seat_limit" class="form-control" value="<?php echo e($course->seat_limit??0); ?>" placeholder="Allowed Seats" required>
				 </div>
...
<?php /**PATH D:\Server_Files\Network Venture\project_7001a\resources\views/components/courses_update_modal.blade.php ENDPATH**/ ?>