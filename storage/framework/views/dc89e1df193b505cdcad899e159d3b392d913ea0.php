			...
			<form method="post" id="update_teacher_form">
				 ...
				 <div class="form-group">
					<input type="text" name="name" class="form-control"
						value="<?php echo e($teacher->name??''); ?>" placeholder="Teacher Name" required />
				 </div>

				 <div class="form-group">
					<input type="text" name="designation" class="form-control"
					value="<?php echo e($teacher->designation??''); ?>" placeholder="Designation" required />
				 </div>

				 <div class="form-group">
					 <textarea class="form-control " style="height:auto" id="" cols="30" 
						name="description"	rows="5" placeholder="Description" required
							 /><?php echo e($teacher->description??''); ?></textarea>
				</div>
...
</div><?php /**PATH D:\Server_Files\Network Venture\project_7001a\resources\views/components/teacher_update_modal.blade.php ENDPATH**/ ?>